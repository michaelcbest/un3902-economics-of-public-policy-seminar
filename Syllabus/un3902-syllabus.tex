...
Office: 1112 IAB \\
Office Hours: Tuesdays 5--5.30 PM \& Thursdays 1:15--2 PM

\subsection*{Meeting Times:}
Tuesdays 2:10--4pm, Location: 1102 IAB
...
\subsection*{Week 1 -- January 20: Introduction}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 2 -- January 27: Empirical Tools in Public Economics}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 3 -- February 3: Externalities and Public Goods I}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 4 -- February 10: Externalities and Public Goods II}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 5 -- February 17: Social Insurance and Redistribution I}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 6 -- February 24: Social Insurance and Redistribution II}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 8 -- March 10: Taxation II}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Weeks 9--11: Student Preliminary Presentations and Discussants}
\begin{itemize}
    \setlength{\itemsep}{0em}
...
\subsection*{Week 9 -- March 31: Student Preliminary Presentations and Discussants I}
\begin{enumerate}
    \setlength{\itemsep}{0em}
    \item Sal, discussed by Peter
    \item Parker, discussed by Pablo
    \item Cara, discussed by Sarah
    \item Alia, discussed by Paul
\end{enumerate}

\subsection*{Week 10 -- April ??: Student Preliminary Presentations and Discussants II}
\begin{itemize}
    \setlength{\itemsep}{0em}
    \item Moe, discussed by Sal
    \item Paarth, discussed by Parker
    \item Peter, discussed by Cara
\end{itemize}

\subsection*{Week 11 -- April 7: Student Preliminary Presentations and Discussants III}
\begin{itemize}
    \setlength{\itemsep}{0em}
    \item Pablo, discussed by Alia
    \item Sarah, discussed by Moe
    \item Paul, discussed by Paarth
\end{itemize}

\subsection*{Week 12 -- April 14: Student Final Presentations I}
\begin{enumerate}
    \setlength{\itemsep}{0em}
    \item Sal
    \item Parker
...
\subsection*{Week 13 -- April 21: Student Final Presentations II}
\begin{enumerate}
    \item Moe
    \item Paarth
    \item Peter
...
\subsection*{Week 14 -- April 28: Student Final Presentations III}
\begin{enumerate}
    \item Pablo
    \item Sarah
    \item Paul
